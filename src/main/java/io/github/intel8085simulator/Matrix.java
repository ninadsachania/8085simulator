...
public class Matrix {
    ...
    int D1;
    int SOD, SDE, SID, R75, R65, R55, MSE, RR75, M75, M65, M55, IE, INTR, _INTA, TRAP, HOLD, _HOLDA, _RESETIN = 1,
            RESETOUT, IO_M, _RD, _WR;
    ...
    public String comment(int i) {
        ...
        switch (i) {
            ...
            case 1:
                return "Register pair BC = " + engine.Dec2Hex(256 * memory[PC + 2] + memory[PC + 1]) + " H";
            case 2:
                return "Contents of Accumulator " + engine.Dec2Hex(A) + "H are copied to memory location " + engine.Dec2Hex(memory[B << 8 + C]) + "H specified by Register Pair BC";
            case 3:
            ...
            case 5:
                return "Register B = Register B - 1";
            case 6:
                return "Register B = " + engine.Dec2Hex2digit(memory[PC + 1]);
            case 7:
                return "";
            case 8:
                return "";
            ...
            case 13:
                return "Register C = Register C + 1";
            case 14:
                return "Register C = " + engine.Dec2Hex2digit(memory[PC + 1]);
            case 15:
                return "";
            case 16:
                return "";
            case 17:
                return "Register pair DE = " + engine.Dec2Hex(256 * memory[PC + 2] + memory[PC + 1]);
            case 18:
                return "";
            case 19:
            ...
            case 21:
                return "Register D = Register D - 1";
            case 22:
                return "Register D = " + engine.Dec2Hex2digit(memory[PC + 1]);
            case 23:
                return "";
            case 24:
                return "";
            ...
            case 29:
                return "Register E = Register E - 1";
            case 30:
                return "Register E = " + engine.Dec2Hex2digit(memory[PC + 1]);
            case 31:
                return "";
            case 32:
                return "";
            case 33:
                return "Register pair HL = " + engine.Dec2Hex(256 * memory[PC + 2] + memory[PC + 1]);
            case 34:
                return "";
            case 35:
            ...
            case 37:
                return "Register H = Register H - 1";
            case 38:
                return "Register H = " + engine.Dec2Hex2digit(memory[PC + 1]);
            case 39:
            ...
            case 45:
                return "Register L = Register L - 1";
            case 46:
                return "Register L = " + engine.Dec2Hex2digit(memory[PC + 1]);
            case 47:
                return "";
            case 48:
                return "";
            case 49:
                return "Stack Pointer(SP) = " + engine.Dec2Hex(256 * memory[PC + 2] + memory[PC + 1]);
            case 50:
                return "";
            case 51:
                return "";
            ...
            case 53:
                return "Memory Content = Memory Content - 1";
            case 54:
                return "Memory location (" + engine.Dec2Hex(256 * H + L) + ") = " + engine.Dec2Hex2digit(memory[PC + 1]);
            case 55:
                return "";
            case 56:
                return "";
            ...
            case 61:
                return "Accumulator = Accumulator - 1";
            case 62:
                return "Accumulator = " + engine.Dec2Hex2digit(memory[PC + 1]);
            case 63:
                return "";
            case 64:
            ...
            case 70:
                return "Register B = " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ")";
            case 71:
            ...
            case 78:
                return "Register C = " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ")";
            case 79:
            ...
            case 86:
                return "Register D = " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ")";
            case 87:
            ...
            case 94:
                return "Register E = " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ")";
            case 95:
            ...
            case 102:
                return "Register H = " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ")";
            case 103:
            ...
            case 110:
                return "Register L = " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ")";
            case 111:
                return "Register L = Accumulator";
            case 112:
                return "Memory location (" + engine.Dec2Hex(256 * H + L) + ") = Register B";
            case 113:
                return "Memory location (" + engine.Dec2Hex(256 * H + L) + ") = Register C";
            case 114:
                return "Memory location (" + engine.Dec2Hex(256 * H + L) + ") = Register D";
            case 115:
                return "Memory location (" + engine.Dec2Hex(256 * H + L) + ") = Register E";
            case 116:
                return "Memory location (" + engine.Dec2Hex(256 * H + L) + ") = Register H";
            case 117:
                return "Memory location (" + engine.Dec2Hex(256 * H + L) + ") = Register L";
            case 118:
                return "Halt";
            case 119:
                return "Memory location (" + engine.Dec2Hex(256 * H + L) + ") = Accumulator";
            case 120:
            ...
            case 126:
                return "Accumulator = " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ")";
            case 127:
            ...
            case 134:
                return "Accumulator=Accumulator + " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ")";
            case 135:
            ...
            case 142:
                return "Accumulator=Accumulator + " + memory[256 * H + L] + " (Content at memory location " + engine.Dec2Hex(256 * H + L) + ") + Carry";
            case 143:
            ...
            case 193:
                return "";
            case 194:
                return "Jump on No Zero to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]) + " [zero = " + ((F & 64) / 64) + "]";
            case 195:
                return "Jump to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]);
            case 196:
                return "";
            case 197:
                return "";
            case 198:
                return "Add " + engine.Dec2Hex2digit(memory[PC + 1]) + " to Accumulator";
            case 199:
                return "Restart from memory address " + engine.Dec2Hex(beginAddress + 0) + " [Interrupt = " + (o.stopAtIndex == 199) + "]";
            case 200:
                return "";
            case 201:
                return "";
            case 202:
                return "Jump on Zero to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]) + " [zero = " + ((F & 64) / 64) + "]";
            case 203:
                return "";
            case 204:
                return "";
            ...
            case 206:
                return "";
            case 207:
                return "Restart from memory address " + engine.Dec2Hex(beginAddress + 8) + " [Interrupt = " + (o.stopAtIndex == 207) + "]";
            case 208:
                return "";
            case 209:
                return "";
            case 210:
                return "Jump on No Carry to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]) + " [carry = " + (F & 1) + "]";
            case 211:
                return "";
            case 212:
                return "";
            ...
            case 214:
                return "";
            case 215:
                return "Restart from memory address " + engine.Dec2Hex(beginAddress + 16) + " [Interrupt = " + (o.stopAtIndex == 215) + "]";
            case 216:
                return "";
            case 217:
                return "";
            case 218:
                return "Jump on Carry to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]) + " [carry = " + (F & 1) + "]";
            case 219:
                return "";
            case 220:
                return "";
            ...
            case 222:
                return "";
            case 223:
                return "Restart from memory address " + engine.Dec2Hex(beginAddress + 24) + " [Interrupt = " + (o.stopAtIndex == 223) + "]";
            case 224:
                return "";
            case 225:
                return "";
            case 226:
                return "Jump on Parity Odd to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]) + " [parity = " + ((F & 4) / 4) + "]";
            case 227:
                return "";
            case 228:
                return "";
            ...
            case 230:
                return "";
            case 231:
                return "Restart from memory address " + engine.Dec2Hex(beginAddress + 32) + " [Interrupt = " + (o.stopAtIndex == 231) + "]";
            case 232:
                return "";
            case 233:
                return "";
            case 234:
                return "Jump on Parity Even to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]) + " [parity = " + ((F & 4) / 4) + "]";
            case 235:
                return "";
            case 236:
                return "";
            ...
            case 238:
                return "";
            case 239:
                return "Restart from memory address " + engine.Dec2Hex(beginAddress + 40) + " [Interrupt = " + (o.stopAtIndex == 239) + "]";
            case 240:
                return "";
            case 241:
                return "";
            case 242:
                return "Jump on Positive to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]) + " [sign = " + ((F & 128) / 128) + "]";
            case 243:
                return "";
            case 244:
                return "";
            ...
            case 246:
                return "";
            case 247:
                return "Restart from memory address " + engine.Dec2Hex(beginAddress + 48) + " [Interrupt = " + (o.stopAtIndex == 247) + "]";
            case 248:
                return "";
            case 249:
                return "";
            case 250:
                return "Jump on Negative to memory location " + engine.Dec2Hex(memory[PC + 2] * 256 + memory[PC + 1]) + " [sign = " + ((F & 128) / 128) + "]";
            case 251:
                return "";
            case 252:
                return "";
            ...
            case 254:
                return "";
            case 255:
                return "Restart from memory address " + engine.Dec2Hex(beginAddress + 56) + " [Interrupt = " + (o.stopAtIndex == 255) + "]";
    ...
    public void functionRun(int index) {
        ...
        switch (index) {
            ...
            case 4://INR B
                ...
                break;
            case 5:
                F = getFlagADD(B, 0xFF) & 0xFE | F & 0x01; //2's complement and carry falg not affected
                B = (B - 1) & 0xff;
                break;
            case 6:
                B = memory[PC++];
            ...
            case 12:
                ...
                break;
            case 13:
                F = getFlagADD(C, 0xFF) & 0xFE | F & 0x01;
                C = (C - 1) & 0xff;
                break;
            case 14:
                C = memory[PC++];
            ...
            case 19:
                ...
                break;
            case 20:
                F = getFlagADD(D, 0x01) & 0xFE | F & 0x01;
                D = (D + 1) & 0xff;
                break;

            case 21:
                F = getFlagADD(D, 0xFF) & 0xFE | F & 0x01;
                D = (D - 1) & 0xff;
                break;
            case 22:
                D = memory[PC++];
            ...
            case 27:
                ...
                break;
            case 28:
                F = getFlagADD(E, 0x01) & 0xFE | F & 0x01;
                E = (E + 1) & 0xff;
                break;
            case 29:
                F = getFlagADD(E, 0xFF) & 0xFE | F & 0x01;
                E = (E - 1) & 0xff;
                break;
            case 30:
                E = memory[PC++];
            ...
            case 31:
                ...
                break;
            case 32:
                A = SID * 128 + R75 * 64 + R65 * 32 + R55 * 16 + IE * 8 + M75 * 4 + M65 * 2 + M55;
                break;
            case 33:
                L = memory[PC++];
                H = memory[PC++];
            ...
            case 35:
                ...
                break;
            case 36:
                F = getFlagADD(H, 0x01) & 0xFE | F & 0x01;
                H = (H + 1) & 0xff;
                break;
            case 37:
                F = getFlagADD(H, 0xFF) & 0xFE | F & 0x01;
                H = (H - 1) & 0xff;
                break;
            case 38:
                H = memory[PC++];
            ...
            case 43:
                ...
                break;
            case 44:
                F = getFlagADD(L, 0x01) & 0xFE | F & 0x01;
                L = (L + 1) & 0xff;
                break;
            case 45:
                F = getFlagADD(L, 0xFF) & 0xFE | F & 0x01;
                L = (L - 1) & 0xff;
                break;
            case 46:
                L = memory[PC++];
            ...
            case 48:
                ...
                break;
            case 49:
                SP = memory[PC++] + memory[PC++] * 256;
                break;
            case 50:
                memory[memory[PC++] + memory[PC++] * 256] = A;
                break;
            case 51:
                SP = (SP + 1) & 0xFFFF;
                break;
            case 52:
                F = getFlagADD(memory[256 * H + L], 0x01) & 0xFE | F & 0x01;
                memory[256 * H + L] = (memory[256 * H + L] + 1) & 0xff;
                break;
            case 53:
                F = getFlagADD(memory[256 * H + L], 0xFF) & 0xFE | F & 0x01;
                memory[256 * H + L] = (memory[256 * H + L] - 1) & 0xff;
                break;
            case 54:
                memory[256 * H + L] = memory[PC++];
                break;
            case 55:
                F = (F | 1);
                break;
            ...
            case 57:
                ...
                break;
            case 58:
                A = memory[memory[PC++] + memory[PC++] * 256];
                break;
            case 59:
                SP--;
                ...
                break;
            case 60:
                F = getFlagADD(A, 0x01) & 0xFE | F & 0x01;
                A = (A + 1) & 0xff;
                break;
            case 61:
                F = getFlagADD(A, 0xFF) & 0xFE | F & 0x01;
                A = (A - 1) & 0xff;
                break;
            case 62:
                A = memory[PC++];
            ...
            case 143:
                ...
                break;
            case 144:
                temp = _2sCompliment(B);
                F = getFlagADD(A, temp);
                F = F ^ 0x01;
                A = (A + temp) & 0xff;
                break;
            case 145:
                temp = _2sCompliment(C);
                F = getFlagADD(A, temp);
                F = F ^ 0x01;
                A = (A + temp) & 0xff;
                break;
            case 146:
                temp = _2sCompliment(D);
                F = getFlagADD(A, temp);
                F = F ^ 0x01;
                A = (A + temp) & 0xff;
                break;
            case 147:
                temp = _2sCompliment(E);
                F = getFlagADD(A, temp);
                F = F ^ 0x01;
                A = (A + temp) & 0xff;
                break;
            case 148:
                temp = _2sCompliment(H);
                F = getFlagADD(A, temp);
                F = F ^ 0x01;
                A = (A + temp) & 0xff;
                break;
            case 149:
                temp = _2sCompliment(L);
                F = getFlagADD(A, temp);
                F = F ^ 0x01;
                A = (A + temp) & 0xff;
                break;
            case 150:
                temp = _2sCompliment(memory[H * 256 + L]);
                F = getFlagADD(A, temp);
                F = F ^ 0x01;
                A = (A + temp) & 0xff;
                break;
            case 151:
                temp = _2sCompliment(A);
                F = getFlagADD(A, temp);
                F = F ^ 0x01;
                A = (A + temp) & 0xff;
                break;
            ...
            case 193:
                ...
                break;
            case 194:
                if ((F & 64) == 0) PC = memory[PC++] + memory[PC++] * 256;
                else {
                    PC += 2;
                    clockCycleCounter -= 3;
                }
            ...
            case 197:
                ...
                break;
            case 198:
                F = getFlagADD(A, memory[PC]);
                A = A + memory[PC++];
                if (A / 256 >= 1) A = A % 256;
                break;
            case 199:
                pushInStack(PC / 256, PC % 256);
                PC = beginAddress;
                break;
            case 200:
                if ((F & 64) == 64) {
            ...
            case 201: {
                ...
                break;
            case 202:
                if ((F & 64) == 64) PC = memory[PC++] + memory[PC++] * 256;
                else {
                    PC += 2;
                    clockCycleCounter -= 3;
                }
    ...
    public void interruptProcess() {
        ...
        if (IE == 1 && R75 == 1 && (RR75 == 0 || _RESETIN == 0) && !(M75 == 1 && MSE == 1)) {
            IE = 0;
            _INTA = 0;
            PC = 0x003C;
        }
        if (IE == 1 && R65 == 1 && (!(M65 == 1 && MSE == 1))) {
            IE = 0;
            _INTA = 0;
            PC = 0x0034;
        }
        if (IE == 1 && R55 == 1 && !(M55 == 1 && MSE == 1)) {
            IE = 0;
            _INTA = 0;
            PC = 0x002C;
        }
